...
def run_example():
    ...
    for i, x in enumerate(col_coords):
        ...
        column_layout = [v0p4p2_7_3_dev0, v0p4p2_7_3_dev1, v0p4p2_7_4_dev0,
                         v0p4p2_7_4_dev1, v0p4p2_7_4_dev0, v0p4p2_7_4_dev1,
                         v0p4p2_7_4_dev0, v0p4p2_7_4_dev1, v0p4p2_7_4_dev0,
    ...
    write_field.write_gds('Ovrcpld_v1p3_apertures.gds')
