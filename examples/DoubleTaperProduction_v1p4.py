...
def run_example():
    ...
    for i, x in enumerate(col_coords):
        ...
        v0p4p2_7_4_dev1 = sivp.OvercoupledAirholeDeviceWSupportv0p4p2(
            ...
            fab_scaling[i])
        v0p4p2_4_4_dev0 = sivp.OvercoupledAirholeDevicev0p4p2(
            pcc_params_4_4, double_taper_params, fab_scaling[i])
        v0p4p2_4_4_dev1 = sivp.OvercoupledAirholeDeviceWSupportv0p4p2(
            pcc_params_4_4, double_taper_w_support_params, fab_scaling[i])
        v0p4p2_3_3_dev0 = sivp.OvercoupledAirholeDevicev0p4p2(
            pcc_params_3_3, double_taper_params, fab_scaling[i])
        v0p4p2_3_3_dev1 = sivp.OvercoupledAirholeDeviceWSupportv0p4p2(
            pcc_params_3_3, double_taper_w_support_params, fab_scaling[i])

        column_layout = [v0p4p2_7_3_dev1, v0p4p2_7_3_dev1, v0p4p2_7_4_dev1,
                         v0p4p2_7_4_dev1, v0p4p2_7_4_dev1, v0p4p2_7_4_dev1,
                         v0p4p2_7_4_dev1, v0p4p2_7_4_dev1, v0p4p2_7_4_dev1,
                         v0p4p2_7_4_dev1, v0p4p2_4_4_dev1, v0p4p2_4_4_dev1,
                         v0p4p2_3_3_dev1, v0p4p2_3_3_dev1, v0p4p2_7_4_dev1]
        ...
        aperture_offsets = np.array([0.853, 0.853, 0.735, 0.735, 0.735, 0.735,
                                    0.735, 0.735, 0.735, 0.735, 0.0, 0.0,
                                    0.0, 0.0, 0.735])
    ...
    write_field.write_gds('Ovrcpld_v1p4_apertures.gds')
